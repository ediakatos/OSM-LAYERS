...
#     output_filename = "/home/evangelos/data/data_sub14/swe_sub14/swe_heal_hea_pt_s3_osm_pp_hospital.shp"
...
#     #     # Convert geometries to centroid points and reproject
...
#             if isinstance(gdf[col].dtype, pd.core.dtypes.dtypes.Dtype) and gdf[col].apply(lambda x: isinstance(x, list)).any():
...
#         os.makedirs(os.path.dirname(OSMHospitalDataDownloader.output_filename), exist_ok=True)

#         # Attempt to save the GeoDataFrame
#         try:
#             gdf.to_file(OSMHospitalDataDownloader.output_filename, driver='ESRI Shapefile')
...
class OSMHospitalDataDownloader:
    ...
    def __init__(self, geojson_path, crs_project, crs_global, country_code):
        ...
        ox.settings.log_console = True
        ox.settings.use_cache = True
        self.output_filename = f"/home/evangelos/osm-data/data_sub14/{country_code}_heal_hea_pt_s3_osm_pp_hospital.shp"
