...
#     output_filename = "/home/evangelos/data/data_sub7/swe_sub7/swe_educ_edu_pt_s3_osm_pp_university.gpkg"
...
class OSMEducationDataDownloader:
    ...
    def __init__(self, geojson_path, crs_project, crs_global, country_code):
        ...
        self.osm_tags = {'amenity': ['university', 'college']}  # Handle multiple values for the 'amenity' key
        ox.config(log_console=True, use_cache=True)
        self.output_filename = f"/home/evangelos/osm-data/data_sub7/{country_code}_educ_edu_pt_s3_osm_pp_university.gpkg"
