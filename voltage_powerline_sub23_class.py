...
class OSMPowerLinesDataDownloader:
    # Class attribute for the output filename with the specified naming convention
    #output_filename = "/home/evangelos/data/data_sub23/swe_sub23/ISO_util_pwl_ln_s2_osm_pp_powerline.shp"
    ...
    def __init__(self, geojson_path, crs_project, crs_global, country_code):
        ...
        self.output_filename = f"/home/evangelos/osm-data/data_sub23/{country_code}_util_pwl_ln_s2_osm_pp_powerline.shp"
    ...
    def download_and_process_data(self):
        ...
        # Download OSM power lines data
        tags = {'power': 'line'}
        gdf = ox.geometries_from_polygon(geometry, tags=tags)

        # Reproject geometries for accurate geometry calculation if they are lines
        if self.crs_project:
...
# Usage example:
# downloader = OSMPowerLinesDataDownloader(
#     geojson_path="path_to_your_geojson_file.geojson",
#     crs_project=27700,  # UK national CRS or any appropriate CRS for accurate calculations
