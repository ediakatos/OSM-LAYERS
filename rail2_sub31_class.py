...
#         self.output_filename = "/home/evangelos/data/data_subXX/swe_subXX/ISO_tran_rst_pt_s2_osm_pp_railwaystation.shp"
...
#         for tag, value in self.osm_min_tags.items():
#             if tag in gdf.columns:
#                 gdf = gdf[gdf[tag] == value]
...
class OSMRailwayStationDataDownloader:
    def __init__(self, geojson_path, crs_project, crs_global, country_code):
        ...
        self.osm_min_tags = {'passenger': 'yes', 'cargo': 'yes'}
        ox.config(log_console=True, use_cache=True)
        self.output_filename = f"/home/evangelos/osm-data/data_sub31/{country_code}_tran_rst_pt_s2_osm_pp_railwaystation.shp"
