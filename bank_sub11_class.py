...
class OSMBankDataDownloader:
    def __init__(self, geojson_path, crs_project, crs_global, country_code):
        ...
        self.osm_tags = {'amenity': 'bank'}  # OSM tags to filter bank data
        ox.settings.log_console = True
        ox.settings.use_cache = True
        self.output_filename = f"/home/evangelos/osm-data/data_sub11//{country_code}_cash_bnk_pt_s0_osm_pp_bank.shp"
