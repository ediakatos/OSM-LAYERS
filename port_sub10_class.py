...
#         self.crs_global = crs_global
#         # Tags to fetch ports
#         self.osm_tags = {'landuse': ['harbour', 'port', 'industrial']}
#         ox.settings.log_console = True
#         ox.settings.use_cache = True
#         self.output_filename = f"/home/evangelos/osm-data/{country_code}/ports4/{country_code}_tran_por_pt_s0_osm_pp_port.shp"
...
#         # Refine filtering to ensure only relevant port features
#         gdf = gdf[((gdf['landuse'] == 'harbour') | (gdf['landuse'] == 'port')) | 
#                   ((gdf['landuse'] == 'industrial') & (gdf['industrial'] == 'port'))]

#         # If the filtered GeoDataFrame is empty, print a message and exit
#         if gdf.empty:
#             print("No port data found in the specified region.")
#             return
...
#         self.crs_project = crs_project
#         self.crs_global = crs_global
#         self.osm_tags = {'landuse': ['harbour', 'port']}
#         ox.settings.log_console = True
#         ox.settings.use_cache = True
#         self.output_filename = f"/home/evangelos/osm-data/{country_code}/ports7/{country_code}_tran_por_pt_s0_osm_pp_port.shp"
