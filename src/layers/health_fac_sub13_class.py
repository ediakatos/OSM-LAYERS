...
class OSMHealthDataDownloader:
    ...
    def __init__(self, geojson_path, crs_project, crs_global, country_code):
        ...
        #self.output_filename = f"/home/evangelos/osm-data/health_facilities/{country_code}_heal_hea_pt_s3_osm_pp_healthfacilities.shp"
    ...
    def process_geometries(self, gdf):
        ...
        #     gdf['fclass'] = self.osm_tags_health

        # # Add 'fclass' and 'name' columns if not present
        # for field in ['fclass', 'name']:
